...
python3 ensemble.py "$predicted_file" $(for i in {1..12}; do echo -n "$predicted_file.$i.npy "; done) #"$predicted_file.1.npy" "$predicted_file.2.npy" "$predicted_file.3.npy" "$predicted_file.4.npy"
rm -f $(for i in {1..12}; do echo -n "$predicted_file.$i.npy "; done) #"$predicted_file.1.npy" "$predicted_file.2.npy" "$predicted_file.3.npy" "$predicted_file.4.npy"
